...
<html>
    ...
    <body>
        ...
        <div id="show-provider" class="content scaffold-show" role="main">
            ...
            <f:display bean="provider" />
            </ol>
            <g:form resource="${provider}" method="DELETE">
                <fieldset class="buttons">
                    <g:link class="edit" action="edit" resource="${provider}"><g:message code="default.button.edit.label" default="Edit" /></g:link>
