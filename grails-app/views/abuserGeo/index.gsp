...
<html>
<head>
    <title>PetPoint - Locations of Animal Abusers</title>
...
<body>
<div style="padding: 10px; font-family: sans-serif; color: #B51851; border-style: groove; font-size: 20px; border-color: cornsilk; border-width: 1px; background-color: rgba(222, 184, 135, 0.95); width: 100%;">
...
<script>
    ...
    var locations = [];
    <g:each in="${abusers}" var="abuser" status="counter">
    locations.push(['${abuser.name}', '${abuser.getFullAddress()}, USA']);
    </g:each>
